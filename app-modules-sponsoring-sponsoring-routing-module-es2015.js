...
let SponsoringComponent = SponsoringComponent_1 = class SponsoringComponent extends _helpers_base_config_component__WEBPACK_IMPORTED_MODULE_4__["BaseConfigComponent"] {
    ...
    _submitData() {
        ...
        this.sponsoringService.submit(data).subscribe(res => {
            ...
            const copySponsors = this._mappedModel$.value;
            for (const sponsor of copySponsors) {
...
/* harmony import */ var _containers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./containers */ "./src/app/modules/sponsoring/containers/index.ts");
