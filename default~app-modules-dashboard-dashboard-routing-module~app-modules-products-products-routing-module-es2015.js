    ...
    ngOnInit() {
        ...
        this.controls['picture'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(id => {
            ...
            if (id === 'custom') {
                ...
                this.selectedCustom = false;
                for (let picture of this.pictureOptions) {
                    if (picture.id == id) {
...
let DeleteProductModalComponent = class DeleteProductModalComponent {
    ...
    deleteProduct() {
        ...
        this.productsService.deleteProduct(this.product_id).subscribe(() => {
...
], DeleteProductModalComponent.prototype, "product_id", void 0);
...
let EditProductModalComponent = class EditProductModalComponent {
    ...
    ngOnInit() {
        if (this.product_id != -1) {
            ...
            this.productsService.getProduct(this.product_id).subscribe(model => {
                this.productForm = this.fb.group({
                ...
                if (model.picture != undefined) {
                    this.productsService.getPictureById(model.picture).subscribe(model => {
                        this.previewURL = 'data:image/gif;base64,' + model.data;
                    });
                }
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number)
], EditProductModalComponent.prototype, "product_id", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("thead > tr > th {\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".sort-icon {\n  height: 0.9rem;\n  width: 0.9rem;\n  margin-left: 0.25rem;\n  margin-top: -0.125rem;\n  vertical-align: middle;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
